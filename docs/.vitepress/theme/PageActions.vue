 ...
 */
const PROMPT = 'Read this DecGuard documentation page and help me with it: '
...
/** The twin's absolute URL: what a model has to be given. */
const twin = ref('')
 ...
 *
 * Deriving it here would make a second place that turns a page into a twin path, and a second
 * derivation that only disagrees in the browser is the kind that goes unnoticed longest.
 *
 ...
 * different file. Test with `npm run build && npm run preview`.
 */
function readTwin() {
